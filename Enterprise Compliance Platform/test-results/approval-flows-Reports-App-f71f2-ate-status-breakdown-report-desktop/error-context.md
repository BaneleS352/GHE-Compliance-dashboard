...
- Name: approval-flows.spec.ts >> Reports >> Approver can generate status breakdown report
- Location: e2e\approval-flows.spec.ts:246:3
...
Call log:
  - waiting for locator('aside nav button:has-text("Reports")')

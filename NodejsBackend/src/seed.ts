...
const workflowInstances: { declarationId: string; steps: string }[] = [
  { declarationId: "GHE-2024-0047", steps: JSON.stringify([{ order: 1, role: "lineManager", assignee: "user-3", assigneeName: "Sipho Nkosi", label: "Line Manager Review", status: "pending", decision: null, notes: "", decidedAt: null, decidedById: null, decidedByName: null }, { order: 2, role: "hr", assignee: "user-4", assigneeName: "Lindiwe Zulu", label: "HR Review", status: "pending", decision: null, notes: "", decidedAt: null, decidedById: null, decidedByName: null }, { order: 3, role: "ceo", assignee: "user-5", assigneeName: "Sandile Shabalala", label: "CEO Approval", status: "pending", decision: null, notes: "", decidedAt: null, decidedById: null, decidedByName: null }]) },
  ...
  { declarationId: "GHE-2025-0022", steps: JSON.stringify([{ order: 1, role: "lineManager", assignee: "user-3", assigneeName: "Sipho Nkosi", label: "Line Manager Review", status: "pending", decision: null, notes: "", decidedAt: null, decidedById: null, decidedByName: null }, { order: 2, role: "hr", assignee: "user-4", assigneeName: "Lindiwe Zulu", label: "HR Review", status: "pending", decision: null, notes: "", decidedAt: null, decidedById: null, decidedByName: null }, { order: 3, role: "ceo", assignee: "user-5", assigneeName: "Sandile Shabalala", label: "CEO Approval", status: "pending", decision: null, notes: "", decidedAt: null, decidedById: null, decidedByName: null }]) },
  { declarationId: "GHE-2025-0023", steps: JSON.stringify([{ order: 1, role: "lineManager", assignee: "user-3", assigneeName: "Sipho Nkosi", label: "Line Manager Review", status: "approved", decision: "accept", notes: "Approved by line manager.", decidedAt: "2025-06-24T09:00:00.000Z", decidedById: null, decidedByName: null }, { order: 2, role: "hr", assignee: "user-4", assigneeName: "Lindiwe Zulu", label: "HR Review", status: "approved", decision: "org", notes: "Approved for organisation pool.", decidedAt: "2025-06-24T11:30:00.000Z", decidedById: null, decidedByName: null }]) },
];
